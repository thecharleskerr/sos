...
cta: { label: "See this week's SIM only picks", href: "/" }
sources:
...
faq:
  ...
  - { q: "How long is a SIM only contract in the UK?", a: "It varies by network and by plan. Three's own eSIM page states it sells 30 day, 12 month and 24 month contracts on SIM only. giffgaff's pricing page refers to an 18 month mobile contract as well as monthly goodybags that roll month to month. Check the exact term on the deal card, since it decides how long a price rise or notice period applies for." }
