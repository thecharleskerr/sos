...
export const perks: Record<string, NetworkPerks> = {
  ...
  /* The seven below were found by one agent on 2026-09-04 from each
     network's own pages and confirmed the same day by a second agent. The
     amounts are quoted as the pages state them:
     Talkmobile: the standing terms say "if you pick a 30 day plan, you and your friend will be eligible for a £10 reward. If you pick a 12 month plan, you will both be eligible for a £15 reward"; the £30 and £20 the first agent found were a doubled promotion that ran 19 January to 23 February 2026.
     ...
     Honest: "your loyalty discount increasing by 5% every year, capped at 30%." (one search summary said "each month" instead; the page itself says every year in both agents' primary quote, and a direct read is listed in docs/TODO.md)
  ...
  talkmobile: { network: 'talkmobile', scheme: 'Refer a friend', detail: '£15 each for you and a friend who takes a 12 month plan, or £10 each on a 30 day plan, as an Amazon gift card once both of you have made two consecutive monthly payments. Doubled during occasional promotions.', eligibility: 'Talkmobile customers and the friends they refer.', source: 'https://talkmobile.co.uk/friend-deals', checked: '2026-09-04', evidence: 'official-page' },
  ...
  /* Found by the second agent on 2026-09-04, one agent each:
     iD Mobile: "iD Mobile offers up to £70 cashback between you and your friend when you refer someone to iD Mobile." and "Data Rollover is a free feature on all iD plans that automatically rolls over your unused data allowance to the next month"
     Lebara: "You can earn up to £50 when you refer someone to Lebara." and "when someone accepts your referral, they get their first 3 months 50% off"
     Utility Warehouse: "New customers who switch two or more qualifying services receive a welcome bonus of up to £150 in Cashback Card credit" and "For every pound you spend with the cashback card, you can earn up to 10% cashback at participating retailers, which comes directly off your monthly UW bill."
     Simp: a referral bonus whose amount is not stated on the page, plus "You can claim a reward with your Simp Coins in the Home page of the app." and "You can get lucky in the weekly Spins and win a prize."
     spusu: two agents searched its pages and found no scheme of any kind. */
  idmobile: { network: 'idmobile', scheme: 'Refer a friend and Data Rollover', detail: 'Up to £70 cashback shared between you and a friend who takes a 24 month phone or SIM only plan through your link, paid after two bills, and unused data rolls into the next month on pay monthly plans.', eligibility: 'The friend registers through the link before buying; Currys, pay as you go, data only and business plans are excluded.', source: 'https://www.idmobile.co.uk/refer-a-friend', checked: '2026-09-04', evidence: 'official-page' },
  lebara: { network: 'lebara', scheme: 'Refer and Earn', detail: 'Up to £50 per successful referral, the amount depending on the plan the friend chooses, paid to a bank account or PayPal, and the friend gets 50% off their first three months.', eligibility: 'Anyone with a referral link; the friend must activate both the SIM and the plan.', source: 'https://www.lebara.co.uk/en/how-to-refer-and-earn.html', checked: '2026-09-04', evidence: 'official-page' },
  uw: { network: 'uw', scheme: 'Bundle welcome bonus and Cashback Card', detail: 'Up to £150 of Cashback Card credit for switching two or more services (£50 for two, £100 for three, £150 for four or more), and the card earns up to 10% cashback at partner retailers, taken off the next bill.', eligibility: 'New customers taking two or more UW services; two mobile SIMs on qualifying tariffs count as two.', source: 'https://uw.co.uk/cashback-card', checked: '2026-09-04', evidence: 'official-page' },
  simp: { network: 'simp', scheme: 'Referral bonus, Simp Coins and weekly spins', detail: 'A referral bonus whose amount the page does not state, paid once the friend pays a full first month; Simp Coins in the app redeem for rewards, and a weekly spin offers prizes.', eligibility: 'Simp customers; the friend must pay the full undiscounted first month.', source: 'https://help.simpmobile.com/en/articles/12254342-how-do-i-get-rewards', checked: '2026-09-04', evidence: 'official-page' },
  spusu: { network: 'spusu', scheme: null, detail: null, eligibility: null, source: 'https://www.spusu.co.uk/', checked: '2026-09-04', evidence: 'official-page' },
  /* Ecotalk describes no rewards scheme (one agent, two searches; its
     pitch is nature projects funded from bills). Revolut's tier discounts
     cover partner subscriptions, not the mobile plan. Klarna is waitlist
     only. */
  bt: unverified('bt'), revolut: unverified('revolut'), klarna: unverified('klarna'), ecotalk: unverified('ecotalk'),
};
