...
export const networks = {
  ...
  bt:         { name: 'BT Mobile',         hostNetwork: 'EE',        colour: '#5514B4', pillText: '#FFFFFF', confirmed: false, affiliate: false,
                note: "Closed to new customers: bt.com now sells EE plans instead. Existing customers keep Roam Like Home. BT's Awin programme (broadband, 3041) has tracked mobile at \u00a30 commission since April 2021.", awin: 3041, awinFeed: null },
