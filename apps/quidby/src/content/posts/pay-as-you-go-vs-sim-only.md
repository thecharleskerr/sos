---
section: "sims"
title: "Pay as you go vs SIM only: which is cheaper for you?"
description: "How pay as you go credit, PAYG bundles and 1, 12 and 24 month SIM only contracts compare on price rises, contract length and roaming, from networks' own pages."
publishDate: 2026-11-05
checked: 2026-09-04
query: "pay as you go vs SIM only"
answer: "If your usage is steady and runs to a few gigabytes or more a month, a rolling 30 day SIM only plan from a network with no stated mid-contract price rise usually beats pay as you go. Pay as you go still wins for very light or occasional use."
deals: ["cheapest", "best-short-contract"]
cta: { label: "See this week's SIM only picks", href: "/sims/" }
sources:
  ...
  - { name: "Three, Changes to your monthly charge, from 9 November 2025", url: "https://www.three.co.uk/support/bills-and-contracts/your-monthly-plan-and-usage/price-increase-9nov25", checked: 2026-09-02 }
...
faq:
  - { q: "Is pay as you go cheaper than SIM only?", a: "It depends on how steady your usage is. If you use a few gigabytes or more every month, a rolling 30 day SIM only plan from a network stating no mid-contract price rise usually costs less over a year than pay as you go, since you stop paying a per-use rate. Pay as you go still wins for very light or occasional use, where a monthly plan would go largely unused." }
  - { q: "Do pay as you go plans have mid-contract price rises?", a: "A price rise attaches to a plan with a minimum term, so pay as you go, which has none, does not carry one in the way a 12 or 24 month SIM only contract can. Rolling SIM only plans work the same way. SMARTY, giffgaff, iD Mobile, Lebara, Simp, Talkmobile and Ecotalk all state no mid-contract price rise, checked on their own pages between 2 and 4 September 2026." }
  - { q: "How long is a SIM only contract in the UK?", a: "It varies by network and by plan. Three's own eSIM page states it sells 30 day, 12 month and 24 month contracts on SIM only. giffgaff's own page refers to an 18 month mobile contract as well as monthly goodybags that roll month to month. Check the exact term on the deal card, since it decides how long a price rise or notice period applies for." }
  - { q: "Does pay as you go roam the same as SIM only in the EU?", a: "On the one network that states it, yes. Lycamobile's own roaming page says all its current pay as you go and pay monthly plans come with EU roaming included as standard, drawing no distinction between the two. Most other networks do not state a difference either way, so check the roaming line on the deal card itself." }
  - { q: "What are the call and data rates on classic pay as you go?", a: "This is not stated in the sources we hold for this guide. Per minute and per megabyte rates change often and sit on each network's own pricing page, so check the current rate there before you top up, rather than relying on a figure here." }
  - { q: "Do I need a credit check for a rolling SIM only plan?", a: "Not on the networks that say so. giffgaff states it will not run a credit check before you join on a SIM only contract, and SMARTY states its SIM only deals, paid up front on a rolling monthly plan, do not require one. Other networks are not stated here, so check before you apply if this matters to you." }
draft: false
---
...
|---|---|---|---|
| O2 | Airtime plans, SIM only included | £2.50 a month | April |
| Vodafone | Pay monthly airtime or data plans, SIM only included | £2.50 a month | 1 April |
| Three | Plans joined or upgraded from 9 November 2025 | £1.80 to £2.30 a month, by data allowance | 1 April |
| EE, editorial only, not an affiliate deal here | SIM only and airtime plans under terms from 7 August 2025 | £2.50 a month | 31 March |
| SMARTY | All plans, which roll monthly | No price rise | Not applicable |
| giffgaff | 18 month contracts, and goodybags that roll month to month | No price rise | Not applicable |
| iD Mobile | SIM only plans | No price rise | Not applicable |
| Lebara | All plans | No price rise | Not applicable |
| Simp | All plans, which roll monthly | No price rise | Not applicable |
...
Work out your last three months of usage. Match it against the shape above, rather than the one you have always used. If it is steady and runs to a few gigabytes or more, [see this week's cheapest SIM only pick](/sims/). It is re-checked every Monday, with the price rise already shown in pounds and pence or as No price rise. If you are still locked into a fixed contract and want out before you switch, we have a guide. [Getting out of a phone contract early](/blog/how-to-get-out-of-a-phone-contract-early/) explains your rights first.
