...
export const networks = {
  ...
  simp:       { name: 'Simp',              hostNetwork: 'Three',        colour: '#F5D200', pillText: '#000000', confirmed: false, affiliate: null,
               note: "Live eSIM network at simpmobile.com, previously listed under a wrong domain. Its plans page states it runs on the Three network. Affiliate status not confirmed. Verified 2026-09-01." },
