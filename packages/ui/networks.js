...
export const networks = {
  ...
  plusnet:    { name: 'Plusnet Mobile',    hostNetwork: 'EE',        colour: '#7A3E98', pillText: '#FFFFFF', confirmed: false, affiliate: true,
               note: "Closed: plus.net states Plusnet Mobile has now closed, services ended June 2024." },
  ...
  simp:       { name: 'Simp',              hostNetwork: null,        colour: '#F5D200', pillText: '#000000', confirmed: false, affiliate: false,
               note: "No affiliate programme. Listed for completeness. Possibly defunct: no official site is indexed and simp.com is a parked domain. Verified 2026-09-01." },
